...
\begin{description}
  ...
  \item[Source-exclusive feature] A transcoder feature that is strongly active under a source
    ...
    during a causal intervention sweep.  The complementary notion, a target-exclusive feature,
  ...
  \item[Intervention sweep] An experiment in which a causal modification of the model's
    ...
    A successful sweep produces a monotone crossover between the source-condition and
