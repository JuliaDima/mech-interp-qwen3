...
is often not straightforwardly understood. A system that has learned approximate heuristics is indistinguishable from one that has learned the intended
algorithm until it collapses under edge cases. 
...
representation without modifying model weights. 
