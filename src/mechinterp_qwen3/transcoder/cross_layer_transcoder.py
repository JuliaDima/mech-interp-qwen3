...
# Some functions/methods have been edited/removed.
import glob
import os
...
from transcoder.activation_functions import JumpReLU, get_default_device
...
class CrossLayerTranscoder(torch.nn.Module):
    ...
    def encode_sparse(self, x, zero_positions: slice | None = None):
    ...
    def compute_attribution_components(self, inputs, zero_positions: slice | None = None):
        if zero_positions is None:
            zero_positions = slice(0, 1)
