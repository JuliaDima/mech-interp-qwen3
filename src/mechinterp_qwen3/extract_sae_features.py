...
def main() -> None:
    ...
    ap.add_argument("--run_path", type=str, required=True, help="Path to run directory with activations")
    ap.add_argument("--transcoder", type=str, default=DEFAULT_TRANSCODER_REPO, help="HuggingFace transcoder repo")
