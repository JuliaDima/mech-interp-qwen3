...
TC_DIR = pathlib.Path("/rds/user/eid23/hpc-work/p28/cache/hf/hub/models--mwhanna--qwen3-4b-transcoders/snapshots/94d176260ac39ce2f882b8b09aba8c118df29bb3")
...
def _encode_layer(layer: int, H_l: np.ndarray) -> np.ndarray:
    ...
    with safe_open(str(TC_DIR / f"layer_{layer}.safetensors"), framework="pt", device="cpu") as f:
