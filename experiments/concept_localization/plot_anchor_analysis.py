...
def _template_string(concept: str, template_key: str | None) -> str | None:
    ...
    if template_key is None:
        return None
    _module_map = {
        "carry":                  "data.concept_datasets.carry_dataset",
        "gcd":                    "data.concept_datasets.gcd_dataset",
        "residue_class":          "data.concept_datasets.residue_class_dataset",
        "perfect_square":         "data.concept_datasets.perfect_square_dataset",
        "decimal_termination":    "data.concept_datasets.decimal_termination_dataset",
        "dot_product_sign":       "data.concept_datasets.dot_product_sign_dataset",
        "conservation":           "data.concept_datasets.conservation_dataset",
        "momentum_conservation":  "data.concept_datasets.momentum_conservation_dataset",
        "doppler_shift":          "data.concept_datasets.doppler_shift_dataset",
        "wave_interference":      "data.concept_datasets.wave_interference_dataset",
        "geometric_series":       "data.concept_datasets.geometric_series_dataset",
        "triangle_inequality":    "data.concept_datasets.triangle_inequality_dataset",
        "balanced_parentheses":   "data.concept_datasets.balanced_parentheses_dataset",
        "negation_scope":         "data.concept_datasets.negation_scope_dataset",
        "syllogism":              "data.concept_datasets.syllogism_dataset",
        "transitive_ordering":    "data.concept_datasets.transitive_ordering_dataset",
        "causal_direction":       "data.concept_datasets.causal_direction_dataset",
    }
